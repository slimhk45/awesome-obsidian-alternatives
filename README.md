...
[^3]: Optional features include cross-platform support, built-in P2P sync, real-time collab, a plugin ecosystem and specialized views (such as graph view or base view) that parse metadata from YAML frontmatter.
