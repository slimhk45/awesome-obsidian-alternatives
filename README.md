...
## Tier 2 (opinionated)
Implementations listed here require an importer step for Obsidian vaults because they have hard-coded the attachment folder or they decided to enforce long paths for wikilinks. They are still required to have a free folder structure for notes and the same file formats as Obsidian.
